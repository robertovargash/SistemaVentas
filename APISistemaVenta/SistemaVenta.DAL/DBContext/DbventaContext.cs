...
public partial class DbventaContext : DbContext
{
  ...
  protected override void OnModelCreating( ModelBuilder modelBuilder )
  {
    ...
    {
      entity.HasKey( e => e.IdCategoria ).HasName( "PK__Categori__8A3D240C951CD299" );
    ...
    {
      entity.HasKey( e => e.IdDetalleVenta ).HasName( "PK__DetalleV__BFE2843FB52877C1" );
    ...
    {
      entity.HasKey( e => e.IdMenu ).HasName( "PK__Menu__C26AF483B5F8C6A9" );
    ...
    {
      entity.HasKey( e => e.IdMenuRol ).HasName( "PK__MenuRol__9D6D61A47AFF8BD3" );
    ...
    {
      entity.HasKey( e => e.IdNumeroDocumento ).HasName( "PK__NumeroDo__471E421AC108CAEB" );
    ...
    {
      entity.HasKey( e => e.IdProducto ).HasName( "PK__Producto__07F4A132DABEDCEC" );
    ...
    {
      entity.HasKey( e => e.IdRol ).HasName( "PK__Rol__3C872F764DA56A99" );
    ...
    {
      entity.HasKey( e => e.Idusuario ).HasName( "PK__Usuario__080A974310AC82EB" );
    ...
    {
      entity.HasKey( e => e.IdVenta ).HasName( "PK__Venta__077D561472F9EE76" );
